...
while True:
    ...
    # Computer takes randomly any number among 1, 2, and 3
    ...
    print("Do you want to play again? (Y/N)")            # Asking if the user wants to play again
    ans = input().lower()
    if ans == 'n':
        break


print("Thanks for playing!")   #outside the while loop
